//string[] Heroes = { "Yuuna Yuuki", "Inaho Kaizuka", "Kazuma Satou", "Subaru Natsuki" };
//string[] Villains = { "Slaine Troyard", "Petelgeuse Romanée-Conti", "Yuno Gasai", "Ken Kaneki", "Momonga" };
//string[] Weapons = { "a shotgun", "potato chips", "a bow", "a grimoire", "empty hands", "a knife", "a cup of instant ramen" };


// Also "D:\\Stuff", @"D:\Stuff\" without Path.Combine();
